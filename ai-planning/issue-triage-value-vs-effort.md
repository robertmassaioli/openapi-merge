...
| 18 | [#4](https://github.com/robertmassaioli/openapi-merge/issues/4) | Servers array is not concatenated/merged | 3 | 2 | **4** | Quick Win | ✅ [16-proposal-4-servers-merge.md](issues/16-proposal-4-servers-merge.md) — implemented, closed |
...
| 23 | [#8](https://github.com/robertmassaioli/openapi-merge/issues/8) | Merge duplicate OAS paths using `disputePrefix` | 4 | 4 | **4** | Big Bet | ✅ Closed — the disjoint-methods case is covered by `duplicatePathHandling: 'merge-operations'` in [11-proposal-71-skip-duplicate-paths.md](issues/11-proposal-71-skip-duplicate-paths.md) §10.5; the literal same-method dispute-prefix ask remains unimplemented |
