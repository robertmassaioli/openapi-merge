...
| [`47-proposal-configurable-extension-merge-strategies.md`](47-proposal-configurable-extension-merge-strategies.md) | ✅ A recursive merge-strategy tree for `x-*` extensions, mirroring the extension's own JSON shape (generalises issue #60 / PR #127) |
