...
| [`42-proposal-external-ref-equality-in-dedup.md`](42-proposal-external-ref-equality-in-dedup.md) | Evaluates PR #87: a crash in component dedup on external `$ref`s, and why the CLI's own ref normalization makes the PR's fix safe to merge |
